# INTRODUCTION
The wiper is a component used to wipe raindrops or any water from the windscreen. The purpose of wipers is to clear water from a windscreen. In most cars, there are two wipers on the windscreen, one on the rear window, and one on each headlight. A rubber wiper blade, the wiper arm that holds the blade, a spring linkage, and parts of the wiper pivots are visible from outside the car. It has six parts called pressure points or claws that are small arms under the wiper

The existing system uses a control stalk to activate the wiper, and pulling up the wiper is difficult. The driver has to switch on and off the control stalk and it reduces their concentration while driving. Hence, this system is proposed to solve all these problems. The concept of this wiper system is similar to other conventional wipers, yet this system will be upgraded to an automatic control system by using a controller. When water hits a dedicated sensor located on the windscreen, the wiper motor will move accordingly which is not detected by sensor, the wiper will automatically stop. This will help the driver to give more concentration and reduce the car accident probability.
...
![1](https://user-images.githubusercontent.com/101246546/168373514-bfc0804d-054d-4e3f-83d9-ef1217eea284.png)
...
![2](https://user-images.githubusercontent.com/101246546/168373597-a42dcf6f-8caa-4c3d-96cd-968b4af3eaac.png)
...
![3](https://user-images.githubusercontent.com/101246546/168373649-c067d4a9-11bb-4766-bf60-1be9b4c73c9c.png)
2. WIPER SPEED LOW
![4](https://user-images.githubusercontent.com/101246546/168373717-352cf831-b4e3-4362-a194-1c17f014625b.png)
3. WIPER SPEED MEDIUM
![5](https://user-images.githubusercontent.com/101246546/168373740-c9845cb0-7d6b-468d-a9ae-a57f9b3a9e55.png)
4. WIPER SPEED IS HIGH
![6](https://user-images.githubusercontent.com/101246546/168373767-378e9b3f-ffa2-4d87-a4a8-2e82f9c391ee.png)
5. user button is pressed and held for 2 seconds, the red LED is off
![7](https://user-images.githubusercontent.com/101246546/168373786-50e4507b-6cb2-4b07-9c91-1ff212af58e2.png)6. WIPER_SYSTEM 1

![8](https://user-images.githubusercontent.com/101246546/168373798-b1f510d0-49b0-43d7-b8c9-2ab9a84982c9.png)
